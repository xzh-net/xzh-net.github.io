...
如果您使用的是 NVIDIA GPU，可以直接使用 pip 安装 vLLM。推荐使用 uv（一个非常快速的 Python 环境管理器）来创建和管理 Python 环境。[安装完成后](/deploy/python?id=_23-%e5%ae%89%e8%a3%85uv%ef%bc%88%e5%8f%af%e9%80%89%ef%bc%89)，您可以使用以下命令创建一个新的 Python 环境并安装 vLLM：
