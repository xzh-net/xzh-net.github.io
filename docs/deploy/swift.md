...
训练完成后，`output` 目录下会生成类似 `Qwen3-4B-Instruct-2507-mcore/v0-20260325-184626/checkpoint-93` 的文件夹。

```lua
[INFO:swift] Successfully saved Megatron model weights in `/workspace/output/Qwen3-4B-Instruct-2507-mcore/v0-20260325-184626/checkpoint-93`.
Train: 100%|████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 93/93 [00:58<00:00,  1.60it/s]
[INFO:swift] End time of running main: 2026-03-25 18:49:19.142357
[INFO:swift] last_model_checkpoint: /workspace/output/v0-20260325-184626/checkpoint-93
...
CUDA_VISIBLE_DEVICES=0,1 \
megatron export \
    --mcore_adapter output/v0-20260325-184626/checkpoint-93 \
    --to_hf true \
    --tensor_model_parallel_size 2 \
    --merge_lora false \
    --torch_dtype bfloat16 \
    --output_dir output/v0-20260325-184626/checkpoint-93-hf \
    --test_convert_precision true
```
...
CUDA_VISIBLE_DEVICES=0,1 \
swift infer \
    --adapters output/v0-20260325-184626/checkpoint-93-hf \
    --stream true
```
...
megatron export \
    ...
    --merge_lora true \
    --torch_dtype bfloat16 \
    --output_dir output/v0-20260325-184626/checkpoint-93-mcore \
    --test_convert_precision true
```
...
训练完成后，`output` 目录下会生成类似 `Qwen3-4B-Instruct-2507/v1-20260325-185659/checkpoint-93` 的文件夹。

```lua
[INFO:swift] Successfully saved `safetensors` model weights in `/workspace/output/Qwen3-4B-Instruct-2507/v1-20260325-185659/checkpoint-93`.
Train: 100%|████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 93/93 [00:52<00:00,  1.76it/s]
[INFO:swift] End time of running main: 2026-03-25 18:59:24.922459
[INFO:swift] last_model_checkpoint: /workspace/output/v1-20260325-185659/checkpoint-93
[INFO:swift] best_model_checkpoint: None
```
...
CUDA_VISIBLE_DEVICES=0,1 \
swift infer \
    --adapters output/v1-20260325-185659/checkpoint-93 \
    --stream true
```
...
CUDA_VISIBLE_DEVICES=0,1 \
swift infer \
    --model output/v2-20260325-190238/checkpoint-93-merged \
    --stream true
```
